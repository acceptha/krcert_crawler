...
from reference.krcert import get_link_page_html, get_link_page_plain, get_table_info


def test_iter_recent_krcert_info_using():
    content = "text"
    ...
    dataframe = pd.DataFrame(
        {
            ...
            1: [
                "제품명",
                "SOHO (Gen5)",
                "Gen6 방화벽 - SOHOW, TZ 300, TZ 300W, TZ 400, TZ 400W, TZ 500, TZ 500W, TZ 600, NSA 2650,\xa0NSA 3600, NSA 3650, NSA 4600, NSA 4650, NSA 5600, NSA 5650, NSA 6600, NSA 6650, SM 9200, SM 9250, SM 9400, SM 9450, SM 9600, SM 9650, TZ 300P, TZ 600P, SOHO 250, SOHO 250W, TZ 350, TZ 350W",
            ...
            3: [
                "해결 버전",
                "5.9.2.14-13o",
                "6.5.2.8-2n (SM9800, NSsp 12400, NSsp 12800용), 6.5.4.15.116n(다른 Gen6 방화벽 어플라이언스용)",
